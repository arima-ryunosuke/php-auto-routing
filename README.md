...
- **logger**: `callable`
    ...
    - デフォルトは何もしません
- basepath: `string`
    - 起動アプリケーションの基底パスを指定します
    - デフォルトは `$_SERVER['SCRIPT_FILENAME']` を加工したなにかです
    - よほど抜き差しならない状況じゃない限り指定する意味はありません
- public: `string`
    - 公開ディレクトリを指定します
    - デフォルトは `$_SERVER['DOCUMENT_ROOT']` です
    - よほど抜き差しならない状況じゃない限り指定する意味はありません
...
- session: `\Symfony\Component\HttpFoundation\Session\SessionInterface`
    - セッションオブジェクトを指定します
    - デフォルトは `\Symfony\Component\HttpFoundation\Session\Session` です
